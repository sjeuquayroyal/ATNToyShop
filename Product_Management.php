                    ...
                    <div class="shoping__cart__table">
                        <table>
                            ...
                            <?php //
                                 if(isset($_GET['id'])){
                                    $id=$_GET['id'];
                                    $result = pg_query($conn,"SELECT product.product_id, product.product_name, /*ranch.branch_nam*/, product.price, product.pro_qty, product.pro_image, category.cat_name 
